        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Your ultimate destination for discovering and tracking movies and TV shows. Stay updated with the latest releases and create your personal watchlist.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 MovieHub. All rights reserved. Built with ❤️ for movie lovers.
            </p>
